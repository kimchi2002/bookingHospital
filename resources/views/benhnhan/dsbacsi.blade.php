            ...
            <table class="table table-striped table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a class="btn" href="{{URL::to('/dienthongtin/chongio/'.$value->MaBS)}}">Chọn lịch </a>
                        </td>
                    </tr>
                    <tr id="{{($value->MaBS)}}">
                    ...
                    $('input:button').click(function() {
                        ...
                        if (flag == 'Lịch khám') {
                            $.ajax({
                                ...
                                error: function(data) {
                                    var x =
                                        `  <td colspan="6"   ><a class="btnxx" > Không có ca trực </a> <br> `;
                                    $('#' + id).show();
                                    $('#' + id).html(x);
                                }
