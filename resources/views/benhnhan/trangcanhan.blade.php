        ...
        <div class="row">
            ...
            <div id="form" class="col-8">
                ...
                <table id="myTable" class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a style="color: green;" class="hihi" data-id="{{($bn->MaBN)}}">Chi tiết</a> | <a
                                style="color: red;" class="hihix" data-id="{{($bn->MaBN)}}">Xóa</a> </td>
                    </tr>
                    @endforeach
                </table>
            ...
            $(document).ready(function() {
                $('.hihi').click(function() {
                    ...
                    $.ajax({
                        url: '/benhvien/trangcanhan/chi-tiet-benh-nhan/' + id,
                        method: "GET",
...
<img data-magnifyby="6" src="{{asset('./public/uploads/benhan/` + data[i].hinh + `')}}" height='100' alt='' />
                ...
                $('.hihix').click(function() {
                    var id = $(this).attr('data-id');
                    $.ajax({
                        url: '/benhvien/trangcanhan/xoa/' + id,
                        method: "GET",
                        success: function(data) {
                            alert(data);
                            if (data.length != 51) {
