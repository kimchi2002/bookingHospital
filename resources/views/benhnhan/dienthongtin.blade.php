...
<head>
    ...
    $(document).ready(function() {
        $('#bn').change(function() {
            ...
            if (id.length > 0) {
                $.ajax({
                    url: '/benhvien/dienthongtin/lay-benh-nhan/' + id,
                    method: "GET",
            ...
            <div id="f" class="col-lg-8">
                ...
                <form class="" action="{{URL::to('/dienthongtin')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                (Ngày sinh) <input class="form-control valid" name="ngaysinh" type="date"
                                    placeholder="Ngày sinh" max="<?php $day = date('Y-m-d', strtotime(' - 365 days'));
                                            echo $day; ?>">
                            </div>
                        </div>
                        <div class="col-sm-8">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">(hình đính kèm)
                                <input onchange="hi()" id="hinh" class="form-control" name="hinh" type="file"
                                    placeholder="">
                            </div>
                        </div>

                        <div class="form-group col-5">
                            <button id="submit" onclick="hi()" type="submit" class="button  boxed-btn">Hoàn tất
                            </button>
                        </div>
                    </div>
