                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a><img src="{{asset('public/frontend/img/logo/logo.png')}}" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-8">
                            ...
                            <div class="footer-logo">
                                ...
                                <img height="100" width="200" src="{{asset('public/frontend/img/logo/yte.png')}}"
                                    alt="">
                                <br>
                                <img style="padding-left:30px ;" height="50" width="100"
                                    src="{{asset('public/frontend/img/logo/face.png')}}" alt="">
