    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <h5>Số điện thoại&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{($value->DienThoai)}}</h5>

                @endforeach
                @foreach($result as $key =>$values)
                <i class="far fa-address-card"></i>
                <h5>Chuyên khoa&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{($values->TenKhoa)}}</h5>
                ...
                <hr>
                <div>
                    <h3>Tiền khám : <?php echo number_format(($values->gia));  ?> VNĐ ≈
                        <?php echo round($values->gia/23000,2); ?> USD</h3>
