...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <a href="{{URL::to('/logout-bacsi')}}" class="dropdown-item"
                                    href="javascript:void(0)"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
                            </div>
                        </li>
                        <!-- ============================================================== -->
        ...
        <aside class="left-sidebar" data-sidebarbg="skin5">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link " href="{{URL::to('/trangbacsi')}}"><i
                                    class="ti-user m-r-5 m-l-5"></i><span class="hide-menu">Trang bác sĩ </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link " href="{{URL::to('/bac-si/lich-truc')}}"><i
                                    class="mdi mdi-receipt"></i><span class="hide-menu">Lịch trực </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{URL::to('/bac-si/danh-sach-benh-nhan?key=all')}}"
                                        class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu">
                                            Bệnh nhân đã khám </span></a></li>
                                <li class="sidebar-item"><a href="{{URL::to('/bac-si/danh-sach-bn?key=all')}}"
                                        class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu">
                                            Bệnh nhân vắng </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"><a href="{{URL::to('/bac-si/chat')}}" class="sidebar-link"
                                id="load"></a></li>
            ...
            <audio id="audi">
                <source src="https://audio-previews.elements.envatousercontent.com/files/262347732/preview.mp3"
                    type="audio/mpeg">
            </audio>
            <!-- End Sidebar scroll-->
        </aside>
        ...
        $(document).ready(function() {
            ...
            function load_tin() {
                ...
                $.ajax({
                    url: '/benhvien/trangbacsi/tai-tin/' + id,
                    method: "GET",
                    success: function(data) {
                        data = JSON.parse(data);
                        if (data == 0) {
                            var resultajax =
                                `<i class="mdi mdi-message-outline"></i><span class="hide-menu"> Chat ` +
                                data + ` </span>`;
                        } else {
                            var resultajax =
                                `<i class="mdi mdi-message-outline"></i><span class="hide-menu error"> Chat ` +
                                data + ` </span>`;
                            console.log(a);
                            if (a == null) {
                                a = data;
