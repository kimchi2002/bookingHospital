            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"> <img src="{{asset('public/frontend/img/logo/logo1.png')}}" alt=""></span>
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Tên" name="Ten"
                                        required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input name="MatKhau" type="Password" class="form-control form-control-lg"
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <input class="btn btn-success float-right" type="submit" value="Sign In"
                                            name="login">
                                    </div>
                                </div>
                            </div>
