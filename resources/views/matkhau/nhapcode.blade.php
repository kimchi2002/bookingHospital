                ...
                <div id="form" class="wrap-login100">
                    <form action="{{URL::to('/xacthuc')}}" method="POST" class="login100-form validate-form">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                            <input id="aa" placeholder="Nhập code của bạn tại đây" required class="input100" type="text" name="code">
                    ...
                    <div class="login100-more">
                        <img height="720" width="610" src="{{asset('public/frontend/img/logo/dangnhap.jpg')}}" alt="">
                    </div>
