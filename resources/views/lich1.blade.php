                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"> Phòng :` + data[i].MaPhong +
                                            ` &nbsp; &nbsp;/ &nbsp;   Buổi ` + data[i]
                                            .Buoi + `</p>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">` + data[i].HocVi + `</h5>
                            <p class="card-text">` + data[i].TenBS + `</p>
                            <p class="card-text"> Phòng :` + data[i].MaPhong + ` &nbsp; &nbsp;/ &nbsp; Buổi ` + data[
                                            i].Buoi + `</p>
                            <input onclick="hii(` + data[i].MaLT + `,'` + data[i].Buoi + `')"  value="chọn" class="btn ahi" type="submit"  />
                        </div>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (buoi.toLowerCase() === "sáng") {
                            if (data[0].ca1 < 5) {
                                resultajax += ` <a href="{{URL::to('/dienthongtin?malt=` + id +
                                    `&time=07:00')}}"  class="col-3 box" >7:00 - 8:00 (` + data[0].ca1 +
                                    `/5)</a>`
                            }
                            if (data[0].ca2 < 5) {
                                resultajax += ` <a href="{{URL::to('/dienthongtin?malt=` + id +
                                    `&time=08:00')}}"  class="col-3 box" >8:00 - 9:00 (` + data[0].ca2 +
                                    `/5)</a>`
                            }
                            if (data[0].ca3 < 5) {
                                resultajax += ` <a href="{{URL::to('/dienthongtin?malt=` + id +
                                    `&time=09:00')}}"  class="col-3 box" >9:00 - 10:00 (` + data[0].ca3 +
                                    `/5)</a>`
                            }
                            if (data[0].ca4 < 5) {
                                resultajax += ` <a href="{{URL::to('/dienthongtin?malt=` + id +
                                    `&time=010:00')}}"  class="col-3 box" >10:00 - 11:00 (` + data[0].ca4 +
                                    `/5)</a>`
                            }
                            ...
                            if (data[0].ca5 < 5) {
                                resultajax += ` <a href="{{URL::to('/dienthongtin?malt=` + id +
                                    `&time=13:30')}}"  class="col-3 box" >13:30 - 14:30 (` + data[0].ca5 +
                                    `/5)</a>`
                            }
                            if (data[0].ca6 < 5) {
                                resultajax += ` <a href="{{URL::to('/dienthongtin?malt=` + id +
                                    `&time=14:30')}}"  class="col-3 box" >14:30 - 15:30 (` + data[0].ca6 +
                                    `/5)</a>`
                            }
                            if (data[0].ca7 < 5) {
                                resultajax += ` <a href="{{URL::to('/dienthongtin?malt=` + id +
                                    `&time=15:30')}}"  class="col-3 box" >15:30 - 16:30 (` + data[0].ca7 +
                                    `/5)</a>`
                            }
                        }
                        $('#' + id).html(resultajax);
